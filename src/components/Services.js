            ...
            <div className='row d-flex justify-content-around'>
                <div className="col-sm-3">
                    <div className="card">
                        ...
                        <div className="card-body ">
                            <h5 className="card-title header">Transparent Pricing</h5>
                ...
                <div className="col-sm-3">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <h5 className="card-title header">Products</h5>
                ...
                <div className="col-sm-3">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <h5 className="card-title header">Shipping and delivery</h5>
